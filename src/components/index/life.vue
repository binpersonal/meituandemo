<template>
  <div class="m-life">
    <el-row>
      <ul class="nav">
        <li>
          <router-link to="/f" class="takeout">美团外卖</router-link>
        </li>
        <li>
          <router-link to="/f">猫眼电影</router-link>
        </li>
        <li>
          <router-link to="/f">美团酒店</router-link>
        </li>
        <li>
          <router-link to="/f" class="apartment">民宿/公寓</router-link>
        </li>
        <li>
          <router-link to="/f" class="business">商家入驻</router-link>
        </li>
        <li>
          <router-link to="/f">美团公益</router-link>
        </li>
      </ul>
    </el-row>
    <el-row>
